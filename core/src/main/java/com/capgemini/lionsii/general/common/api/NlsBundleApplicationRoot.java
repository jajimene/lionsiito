package com.capgemini.lionsii.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.capgemini.lionsii.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see com.capgemini.lionsii.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
