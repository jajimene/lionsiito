package com.capgemini.lionsii.general.service.impl.config;
...
import com.capgemini.lionsii.general.common.impl.security.CsrfRequestMatcher;
...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    String[] unsecuredResources =
        new String[] { "/login", "/prueba/**", "/security/**", "/services/rest/login", "/services/rest/logout" };
